...
0000000000400d70 <__do_global_dtors_aux>:
  400d70:	80 3d 21 3a 20 00 00 	cmpb   $0x0,0x203a21(%rip)        # 604798 <completed.6354>
  ...
  400d82:	5d                   	pop    %rbp
  400d83:	c6 05 0e 3a 20 00 01 	movb   $0x1,0x203a0e(%rip)        # 604798 <completed.6354>
...
0000000000400dbd <main>:
  ...
  400e2c:	e8 16 05 00 00       	callq  401347 <initialize_bomb>
...
0000000000400f0c <phase_2>:
  ...
  400f15:	e8 60 06 00 00       	callq  40157a <read_six_numbers>
  ...
  400f27:	e8 18 06 00 00       	callq  401544 <explode_bomb>
  ...
  400f38:	e8 07 06 00 00       	callq  401544 <explode_bomb>
...
0000000000400f5b <phase_3>:
  ...
  400f69:	be 8d 27 40 00       	mov    $0x40278d,%esi
...
0000000000400fe6 <func4>:
  ...
  400feb:	89 c3                	mov    %eax,%ebx
  400fed:	c1 eb 1f             	shr    $0x1f,%ebx
  400ff0:	01 d8                	add    %ebx,%eax
  400ff2:	d1 f8                	sar    %eax
  400ff4:	8d 1c 30             	lea    (%rax,%rsi,1),%ebx
  400ff7:	39 fb                	cmp    %edi,%ebx
  400ff9:	7e 0c                	jle    401007 <func4+0x21>
  400ffb:	8d 53 ff             	lea    -0x1(%rbx),%edx
  400ffe:	e8 e3 ff ff ff       	callq  400fe6 <func4>
  401003:	01 d8                	add    %ebx,%eax
  401005:	eb 10                	jmp    401017 <func4+0x31>
  401007:	89 d8                	mov    %ebx,%eax
  401009:	39 fb                	cmp    %edi,%ebx
  40100b:	7d 0a                	jge    401017 <func4+0x31>
  40100d:	8d 73 01             	lea    0x1(%rbx),%esi
  401010:	e8 d1 ff ff ff       	callq  400fe6 <func4>
  401015:	01 d8                	add    %ebx,%eax
  401017:	5b                   	pop    %rbx
  401018:	c3                   	retq   

0000000000401019 <phase_4>:
  401019:	48 83 ec 18          	sub    $0x18,%rsp
  40101d:	48 8d 4c 24 08       	lea    0x8(%rsp),%rcx
  401022:	48 8d 54 24 0c       	lea    0xc(%rsp),%rdx
  401027:	be 8d 27 40 00       	mov    $0x40278d,%esi
  40102c:	b8 00 00 00 00       	mov    $0x0,%eax
  401031:	e8 fa fb ff ff       	callq  400c30 <__isoc99_sscanf@plt>
  401036:	83 f8 02             	cmp    $0x2,%eax
  401039:	75 07                	jne    401042 <phase_4+0x29>
  40103b:	83 7c 24 0c 0e       	cmpl   $0xe,0xc(%rsp)
  401040:	76 05                	jbe    401047 <phase_4+0x2e>
  401042:	e8 fd 04 00 00       	callq  401544 <explode_bomb>
  401047:	ba 0e 00 00 00       	mov    $0xe,%edx
  40104c:	be 00 00 00 00       	mov    $0x0,%esi
  401051:	8b 7c 24 0c          	mov    0xc(%rsp),%edi
  401055:	e8 8c ff ff ff       	callq  400fe6 <func4>
  40105a:	83 f8 12             	cmp    $0x12,%eax
  40105d:	75 07                	jne    401066 <phase_4+0x4d>
  40105f:	83 7c 24 08 12       	cmpl   $0x12,0x8(%rsp)
  401064:	74 05                	je     40106b <phase_4+0x52>
  401066:	e8 d9 04 00 00       	callq  401544 <explode_bomb>
  40106b:	48 83 c4 18          	add    $0x18,%rsp
  40106f:	c3                   	retq   

0000000000401070 <phase_5>:
  401070:	53                   	push   %rbx
  401071:	48 83 ec 10          	sub    $0x10,%rsp
  401075:	48 89 fb             	mov    %rdi,%rbx
  401078:	e8 44 02 00 00       	callq  4012c1 <string_length>
  40107d:	83 f8 06             	cmp    $0x6,%eax
  401080:	74 40                	je     4010c2 <phase_5+0x52>
  401082:	e8 bd 04 00 00       	callq  401544 <explode_bomb>
  401087:	eb 39                	jmp    4010c2 <phase_5+0x52>
  401089:	0f b6 14 03          	movzbl (%rbx,%rax,1),%edx
  40108d:	83 e2 0f             	and    $0xf,%edx
  401090:	0f b6 92 30 25 40 00 	movzbl 0x402530(%rdx),%edx
  401097:	88 14 04             	mov    %dl,(%rsp,%rax,1)
  40109a:	48 83 c0 01          	add    $0x1,%rax
  40109e:	48 83 f8 06          	cmp    $0x6,%rax
  4010a2:	75 e5                	jne    401089 <phase_5+0x19>
  4010a4:	c6 44 24 06 00       	movb   $0x0,0x6(%rsp)
  4010a9:	be e6 24 40 00       	mov    $0x4024e6,%esi
  4010ae:	48 89 e7             	mov    %rsp,%rdi
  4010b1:	e8 28 02 00 00       	callq  4012de <strings_not_equal>
  4010b6:	85 c0                	test   %eax,%eax
  4010b8:	74 0f                	je     4010c9 <phase_5+0x59>
  4010ba:	e8 85 04 00 00       	callq  401544 <explode_bomb>
  4010bf:	90                   	nop
  4010c0:	eb 07                	jmp    4010c9 <phase_5+0x59>
  4010c2:	b8 00 00 00 00       	mov    $0x0,%eax
  4010c7:	eb c0                	jmp    401089 <phase_5+0x19>
  4010c9:	48 83 c4 10          	add    $0x10,%rsp
  4010cd:	5b                   	pop    %rbx
  4010ce:	c3                   	retq   

00000000004010cf <phase_6>:
  4010cf:	41 55                	push   %r13
  4010d1:	41 54                	push   %r12
  4010d3:	55                   	push   %rbp
  4010d4:	53                   	push   %rbx
  4010d5:	48 83 ec 58          	sub    $0x58,%rsp
  4010d9:	48 8d 74 24 30       	lea    0x30(%rsp),%rsi
  4010de:	e8 97 04 00 00       	callq  40157a <read_six_numbers>
  4010e3:	4c 8d 6c 24 30       	lea    0x30(%rsp),%r13
  4010e8:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  4010ee:	4c 89 ed             	mov    %r13,%rbp
  4010f1:	41 8b 45 00          	mov    0x0(%r13),%eax
  4010f5:	83 e8 01             	sub    $0x1,%eax
  4010f8:	83 f8 05             	cmp    $0x5,%eax
  4010fb:	76 05                	jbe    401102 <phase_6+0x33>
  4010fd:	e8 42 04 00 00       	callq  401544 <explode_bomb>
  401102:	41 83 c4 01          	add    $0x1,%r12d
  401106:	41 83 fc 06          	cmp    $0x6,%r12d
  40110a:	75 07                	jne    401113 <phase_6+0x44>
  40110c:	be 00 00 00 00       	mov    $0x0,%esi
  401111:	eb 42                	jmp    401155 <phase_6+0x86>
  401113:	44 89 e3             	mov    %r12d,%ebx
  401116:	48 63 c3             	movslq %ebx,%rax
  401119:	8b 44 84 30          	mov    0x30(%rsp,%rax,4),%eax
  40111d:	39 45 00             	cmp    %eax,0x0(%rbp)
  401120:	75 05                	jne    401127 <phase_6+0x58>
  401122:	e8 1d 04 00 00       	callq  401544 <explode_bomb>
  401127:	83 c3 01             	add    $0x1,%ebx
  40112a:	83 fb 05             	cmp    $0x5,%ebx
  40112d:	7e e7                	jle    401116 <phase_6+0x47>
  40112f:	49 83 c5 04          	add    $0x4,%r13
  401133:	eb b9                	jmp    4010ee <phase_6+0x1f>
  401135:	48 8b 52 08          	mov    0x8(%rdx),%rdx
  401139:	83 c0 01             	add    $0x1,%eax
  40113c:	39 c8                	cmp    %ecx,%eax
  40113e:	75 f5                	jne    401135 <phase_6+0x66>
  401140:	eb 05                	jmp    401147 <phase_6+0x78>
  401142:	ba f0 42 60 00       	mov    $0x6042f0,%edx
  401147:	48 89 14 74          	mov    %rdx,(%rsp,%rsi,2)
  40114b:	48 83 c6 04          	add    $0x4,%rsi
  40114f:	48 83 fe 18          	cmp    $0x18,%rsi
  401153:	74 15                	je     40116a <phase_6+0x9b>
  401155:	8b 4c 34 30          	mov    0x30(%rsp,%rsi,1),%ecx
  401159:	83 f9 01             	cmp    $0x1,%ecx
  40115c:	7e e4                	jle    401142 <phase_6+0x73>
  40115e:	b8 01 00 00 00       	mov    $0x1,%eax
  401163:	ba f0 42 60 00       	mov    $0x6042f0,%edx
  401168:	eb cb                	jmp    401135 <phase_6+0x66>
  40116a:	48 8b 1c 24          	mov    (%rsp),%rbx
  40116e:	48 8d 44 24 08       	lea    0x8(%rsp),%rax
  401173:	48 8d 74 24 30       	lea    0x30(%rsp),%rsi
  401178:	48 89 d9             	mov    %rbx,%rcx
  40117b:	48 8b 10             	mov    (%rax),%rdx
  40117e:	48 89 51 08          	mov    %rdx,0x8(%rcx)
  401182:	48 83 c0 08          	add    $0x8,%rax
  401186:	48 39 f0             	cmp    %rsi,%rax
  401189:	74 05                	je     401190 <phase_6+0xc1>
  40118b:	48 89 d1             	mov    %rdx,%rcx
  40118e:	eb eb                	jmp    40117b <phase_6+0xac>
  401190:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)
  401197:	00 
  401198:	bd 05 00 00 00       	mov    $0x5,%ebp
  40119d:	48 8b 43 08          	mov    0x8(%rbx),%rax
  4011a1:	8b 00                	mov    (%rax),%eax
  4011a3:	39 03                	cmp    %eax,(%rbx)
  4011a5:	7e 05                	jle    4011ac <phase_6+0xdd>
  4011a7:	e8 98 03 00 00       	callq  401544 <explode_bomb>
  4011ac:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4011b0:	83 ed 01             	sub    $0x1,%ebp
  4011b3:	75 e8                	jne    40119d <phase_6+0xce>
  4011b5:	48 83 c4 58          	add    $0x58,%rsp
  4011b9:	5b                   	pop    %rbx
  4011ba:	5d                   	pop    %rbp
  4011bb:	41 5c                	pop    %r12
  4011bd:	41 5d                	pop    %r13
  4011bf:	c3                   	retq   

00000000004011c0 <fun7>:
  4011c0:	48 83 ec 08          	sub    $0x8,%rsp
  4011c4:	48 85 ff             	test   %rdi,%rdi
  4011c7:	74 2b                	je     4011f4 <fun7+0x34>
  4011c9:	8b 17                	mov    (%rdi),%edx
  4011cb:	39 f2                	cmp    %esi,%edx
  4011cd:	7e 0d                	jle    4011dc <fun7+0x1c>
  4011cf:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  4011d3:	e8 e8 ff ff ff       	callq  4011c0 <fun7>
  4011d8:	01 c0                	add    %eax,%eax
  4011da:	eb 1d                	jmp    4011f9 <fun7+0x39>
  4011dc:	b8 00 00 00 00       	mov    $0x0,%eax
  4011e1:	39 f2                	cmp    %esi,%edx
  4011e3:	74 14                	je     4011f9 <fun7+0x39>
  4011e5:	48 8b 7f 10          	mov    0x10(%rdi),%rdi
  4011e9:	e8 d2 ff ff ff       	callq  4011c0 <fun7>
  4011ee:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  4011f2:	eb 05                	jmp    4011f9 <fun7+0x39>
  4011f4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4011f9:	48 83 c4 08          	add    $0x8,%rsp
  4011fd:	c3                   	retq   

00000000004011fe <secret_phase>:
  4011fe:	53                   	push   %rbx
  4011ff:	e8 b8 03 00 00       	callq  4015bc <read_line>
  401204:	ba 0a 00 00 00       	mov    $0xa,%edx
  401209:	be 00 00 00 00       	mov    $0x0,%esi
  40120e:	48 89 c7             	mov    %rax,%rdi
  401211:	e8 ea f9 ff ff       	callq  400c00 <strtol@plt>
  401216:	48 89 c3             	mov    %rax,%rbx
  401219:	8d 40 ff             	lea    -0x1(%rax),%eax
  40121c:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  401221:	76 05                	jbe    401228 <secret_phase+0x2a>
  401223:	e8 1c 03 00 00       	callq  401544 <explode_bomb>
  401228:	89 de                	mov    %ebx,%esi
  40122a:	bf 10 41 60 00       	mov    $0x604110,%edi
  40122f:	e8 8c ff ff ff       	callq  4011c0 <fun7>
  401234:	83 f8 07             	cmp    $0x7,%eax
  401237:	74 05                	je     40123e <secret_phase+0x40>
  401239:	e8 06 03 00 00       	callq  401544 <explode_bomb>
  40123e:	bf c0 24 40 00       	mov    $0x4024c0,%edi
  401243:	e8 f8 f8 ff ff       	callq  400b40 <puts@plt>
  401248:	e8 95 04 00 00       	callq  4016e2 <phase_defused>
  40124d:	5b                   	pop    %rbx
  40124e:	c3                   	retq   
  40124f:	90                   	nop
...
0000000000401250 <sig_handler>:
  ...
  401259:	e8 e2 f8 ff ff       	callq  400b40 <puts@plt>
  40125e:	bf 03 00 00 00       	mov    $0x3,%edi
  401263:	e8 38 fa ff ff       	callq  400ca0 <sleep@plt>
  401268:	bf 09 27 40 00       	mov    $0x402709,%edi
  40126d:	b8 00 00 00 00       	mov    $0x0,%eax
  401272:	e8 e9 f8 ff ff       	callq  400b60 <printf@plt>
  401277:	48 8b 3d 02 35 20 00 	mov    0x203502(%rip),%rdi        # 604780 <__TMC_END__>
  40127e:	e8 9d f9 ff ff       	callq  400c20 <fflush@plt>
  401283:	bf 01 00 00 00       	mov    $0x1,%edi
  401288:	e8 13 fa ff ff       	callq  400ca0 <sleep@plt>
  40128d:	bf 11 27 40 00       	mov    $0x402711,%edi
  401292:	e8 a9 f8 ff ff       	callq  400b40 <puts@plt>
  401297:	bf 10 00 00 00       	mov    $0x10,%edi
  40129c:	e8 df f9 ff ff       	callq  400c80 <exit@plt>
...
00000000004012a1 <invalid_phase>:
  ...
  4012b2:	e8 a9 f8 ff ff       	callq  400b60 <printf@plt>
...
0000000000401347 <initialize_bomb>:
  ...
  401359:	e8 62 f8 ff ff       	callq  400bc0 <signal@plt>
  40135e:	be 40 00 00 00       	mov    $0x40,%esi
  401363:	48 8d bc 24 00 20 00 	lea    0x2000(%rsp),%rdi
  40136a:	00 
  40136b:	e8 f0 f8 ff ff       	callq  400c60 <gethostname@plt>
  ...
  40138c:	e8 af f7 ff ff       	callq  400b40 <puts@plt>
  ...
  4013a2:	00 
  4013a3:	e8 68 f7 ff ff       	callq  400b10 <strcasecmp@plt>
  ...
  4013c8:	e8 93 f7 ff ff       	callq  400b60 <printf@plt>
  4013cd:	bf 08 00 00 00       	mov    $0x8,%edi
  4013d2:	e8 a9 f8 ff ff       	callq  400c80 <exit@plt>
  4013d7:	bf b0 25 40 00       	mov    $0x4025b0,%edi
  4013dc:	e8 5f f7 ff ff       	callq  400b40 <puts@plt>
...
0000000000401402 <blank_line>:
  ...
  40140d:	e8 9e f8 ff ff       	callq  400cb0 <__ctype_b_loc@plt>
...
000000000040143f <skip>:
  ...
  401462:	e8 49 f7 ff ff       	callq  400bb0 <fgets@plt>
...
0000000000401480 <send_msg>:
  ...
  4014cb:	e8 90 f6 ff ff       	callq  400b60 <printf@plt>
  4014d0:	bf 08 00 00 00       	mov    $0x8,%edi
  4014d5:	e8 a6 f7 ff ff       	callq  400c80 <exit@plt>
  ...
  401502:	e8 69 f7 ff ff       	callq  400c70 <sprintf@plt>
  ...
  40152d:	e8 0e f6 ff ff       	callq  400b40 <puts@plt>
  401532:	bf 00 00 00 00       	mov    $0x0,%edi
  401537:	e8 44 f7 ff ff       	callq  400c80 <exit@plt>
...
00000000004015bc <read_line>:
  ...
  4015e4:	e8 57 f5 ff ff       	callq  400b40 <puts@plt>
  4015e9:	bf 08 00 00 00       	mov    $0x8,%edi
  4015ee:	e8 8d f6 ff ff       	callq  400c80 <exit@plt>
  4015f3:	bf b1 27 40 00       	mov    $0x4027b1,%edi
  4015f8:	e8 03 f5 ff ff       	callq  400b00 <getenv@plt>
  4015fd:	48 85 c0             	test   %rax,%rax
  401600:	74 0a                	je     40160c <read_line+0x50>
  401602:	bf 00 00 00 00       	mov    $0x0,%edi
  401607:	e8 74 f6 ff ff       	callq  400c80 <exit@plt>
  ...
  40162e:	e8 0d f5 ff ff       	callq  400b40 <puts@plt>
  401633:	bf 00 00 00 00       	mov    $0x0,%edi
  401638:	e8 43 f6 ff ff       	callq  400c80 <exit@plt>
  ...
  401677:	e8 c4 f4 ff ff       	callq  400b40 <puts@plt>
...
00000000004016e2 <phase_defused>:
  ...
  401717:	e8 14 f5 ff ff       	callq  400c30 <__isoc99_sscanf@plt>
  ...
  401739:	e8 02 f4 ff ff       	callq  400b40 <puts@plt>
  40173e:	bf 60 26 40 00       	mov    $0x402660,%edi
  401743:	e8 f8 f3 ff ff       	callq  400b40 <puts@plt>
  401748:	b8 00 00 00 00       	mov    $0x0,%eax
  40174d:	e8 ac fa ff ff       	callq  4011fe <secret_phase>
  401752:	bf 98 26 40 00       	mov    $0x402698,%edi
  401757:	e8 e4 f3 ff ff       	callq  400b40 <puts@plt>
  40175c:	bf c8 26 40 00       	mov    $0x4026c8,%edi
  401761:	e8 da f3 ff ff       	callq  400b40 <puts@plt>
...
00000000004018b0 <submitr>:
  ...
  401bef:	be c8 28 40 00       	mov    $0x4028c8,%esi
  ...
  401d8d:	00 
  401d8e:	be cf 28 40 00       	mov    $0x4028cf,%esi
...
0000000000402091 <init_driver>:
  ...
  402130:	bf e0 28 40 00       	mov    $0x4028e0,%edi
  ...
  4021d3:	66 c7 44 24 02 6d b1 	movw   $0xb16d,0x2(%rsp)
  ...
  4021ed:	ba e0 28 40 00       	mov    $0x4028e0,%edx
  4021f2:	be a0 28 40 00       	mov    $0x4028a0,%esi
...
000000000040222f <driver_post>:
  ...
  40223e:	bf ef 28 40 00       	mov    $0x4028ef,%edi
  ...
  402270:	41 b9 06 29 40 00    	mov    $0x402906,%r9d
  402276:	49 89 f0             	mov    %rsi,%r8
  402279:	48 89 f9             	mov    %rdi,%rcx
  40227c:	ba 11 29 40 00       	mov    $0x402911,%edx
  402281:	be b1 6d 00 00       	mov    $0x6db1,%esi
  402286:	bf e0 28 40 00       	mov    $0x4028e0,%edi
